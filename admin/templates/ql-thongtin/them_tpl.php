...
<div class="bs-example bs-example-tabs" data-example-id="togglable-tabs">
 ...
 -->
					...
					<tr>
						...
						<td class="td_right">
							<input class="input form-control  width400"  name="google_plus" value="<?php echo @$items[0]['google_plus']?>"  />
						</td>
					</tr>
					...
					<tr>
						...
						<td class="td_right">
							<input class="input form-control  width400"  name="zalo" value="<?php echo @$items[0]['zalo']?>"  />
						</td>
					</tr>
