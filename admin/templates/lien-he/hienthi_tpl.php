...
<table class="table table-bordered table-hover">
	<thead>
		<tr>
            ...
            <th style="width:8%">Loại liên hệ</th>
	...
	<tbody>
		...
		<tr>
            ...
            <td>
			<?php $arrTypeRender = [
					'recruitment' => ['text' => 'Tuyển dụng', 'type' => 'btn-success'], 
					'email' => ['text' => 'Nhận thông tin', 'type' => 'btn-warning'], 
					'contact-page' => ['text' => 'Liên hệ', 'type' => 'btn-info'], 
					'contact' => ['text' => 'Tư vấn', 'type' => 'btn-danger']
				]; 
				$strType = $items[$i]['type']; ?>
			<button type="button" class="btn <?= $arrTypeRender[$strType]['type']; ?>"><?= $arrTypeRender[$strType]['text']; ?></button>
			</td>
			 <td align="center">
